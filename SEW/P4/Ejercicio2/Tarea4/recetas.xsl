  ...
  <xsl:template match="/">
    ...
    <html>
      <head>
        ...
        <title>P4. Ejercicio2 - Tarea4</title>
      </head>
      <body>
        <h1>Ejercicio2 - Tarea4</h1>
        <h2>Todas las recetas sin leche y queso</h2>

        <xsl:for-each select="recetas/receta">

          <xsl:if test="(not (contains(lower-case(ingredientes), 'leche'))) and (not (contains(lower-case(ingredientes), 'queso')))">
